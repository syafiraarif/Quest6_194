package com.example.quest6_194.view
...
import com.example.quest6_194.model.Siswa
...
fun TampilSiswa (
    ...
    val items = listOf(
        Pair(stringResource(id = R.string.nama_lengkap), statusIUSiswa.nama),
        Pair(stringResource(id = R.string.jenis_kelamin), statusIUSiswa.gender),
        Pair(stringResource(id = R.string.alamat), statusIUSiswa.alamat)
    )
